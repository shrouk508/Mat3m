...
namespace Mat3m.Areas.Admin.Controllers
{
    ...
    public class ContactUsController : Controller
    {
        ...
        public ContactUsController(Mat3amContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Titel,Email,Massage")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Titel,Email,Massage")] ContactUs contactUs)
        {
            if (id != contactUs.Id)
            {
                return NotFound();
